...
if __name__ == "__main__":
    ...
    # intializing necessary variables for controller
    # previous value of force
    prev_force = 0
    # time domain error
    error_in_time = [0, 0, 0]
    # PID constants
    ...
    while not crashed:
        ...
        x_desired = 300
        actual_error = x_desired - x
        error_in_time[0], error_in_time[1], error_in_time[2] =error_in_time[1], error_in_time[2], actual_error

        force, prev_force, error_in_time = controller(error_in_time, prev_force, PID, delta_t)
